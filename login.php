...
if (isset($_POST["login"])) {
    // $user = strtolower(mysqli_real_escape_string($connect, stripslashes($_POST["username"])));
    $user = mysqli_real_escape_string($connect, $_POST["username"]);
    $passwd = mysqli_real_escape_string($connect, $_POST["passwd"]);

    $result = recordUser($user, "username", "customers");
...
<body>
    <div class="container position-relative">
        <div class="position-absolute reg-btn">
            <a href="userRegister.php" class="add-btn px-3 py-2 mx-md-0 mx-5 text-white">
